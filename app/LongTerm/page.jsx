...
function page() {
  ...
  const getData =() => {
    axios.get('http://localhost:8000/api/v1/rental/view/LongRentals/',{
      headers: {
    ...
    <div>
      ...
      <div className="border-t-2 py-4 border-b-2 px-6 gap-4 flex">
        ...
        >
          ...
          <option value="1000">APARTMENT</option>
          <option value="5000">HOUSE</option>
        </select>
        ...
        >
          ...
          <option value="YES">Not Friently</option>
        </select>
        ...
        <select
          ...
          className="border border-gray-400 rounded-lg p-2 text-xl"
        >
          <option value="non">Non A/C</option>
      ...
      <div className=" pl-6 flex">
                  ...
                  return(
                    ...
                    <div className="w-[350px]" onClick={() => {
                      ...
                      <div>
                        ...
                        <div>
                          <h3 className="text-3xl font-sans">{item.house_name}</h3>
        ...
        <div className="bg-red-400 w-[27%] h-[85vh]">
