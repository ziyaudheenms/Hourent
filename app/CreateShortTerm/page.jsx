...
function page() { 
  ...
  const HandleSubmitEvent = async () => {
    ...
    try {
      ...
      await axios.post("http://localhost:8000/api/v1/rental/create/shortTerm/rental/", formData ,{
        headers: {
  ...
  return (
    <div className="p-6 bg-[url('https://th.bing.com/th/id/OIP.f_vD05JlDFYFsL1uOBs85AAAAA?w=338&h=338&rs=1&pid=ImgDetMain')] bg-no-repeat bg-cover bg-center bg-fixed">
      <h1 className="text-5xl text-center font-bold ">
        CREATE YOUR SHORT TERM RENT
      </h1>
      <form
        action=""
        method="post"
